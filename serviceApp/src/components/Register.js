...
class Register extends Component<Props> {
  ...
  render() {
    ...
    const { emailOrPhone, userName, password } = this.state;
    let disable = true;
          ...
          <Container transparentBgColor>
            ...
            <Content>
              ...
              <Form style={{marginTop : 10}}>
                ...
                >
                  <View style={styles.center}>
                    <IconFontAw5 name="edit" size={18} color="#078CD6" />
                    <Text lgBlue fontSize16 marginLeft10>
                      Register
                    </Text>
                  </View>
                </Button>
              ...
              <View f_row space_between>
                ...
                <Text babyBlue margin fontSize12 onPress={this.goToLogin}>
                  Login
                </Text>
              </View>
            </Content>
